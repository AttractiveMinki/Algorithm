...
def move(temp_list):
    ...
    for i in range(4):
        cr = head_r + dr[i]
        cc = head_c + dc[i]
        if 0 <= cr < N and 0 <= cc < N and grounds[cr][cc] == 4:
...
def get_score(temp_r, temp_c):
    ...
    while queue:
        ...
        for i in range(4):
            cr = qr + dr[i]
            cc = qc + dc[i]
            if 0 <= cr < N and 0 <= cc < N and 0 < grounds[cr][cc] < 4 and visited[cr][cc] == 0:
                visited[cr][cc] = 1
        ...
        if grounds[r][c] == 1:
            ...
            while queue:
                ...
                for i in range(4):
                    cr = qr + dr[i]
                    cc = qc + dc[i]
                    if 0 <= cr < N and 0 <= cc < N and visited[cr][cc] == 0 and 0 < grounds[cr][cc] < 4:
                        visited[cr][cc] = 1
